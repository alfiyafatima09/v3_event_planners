...
const Footer: React.FC = () => {
  ...
  const eventTypes = [
    ...
    { name: 'Engagements', href: '/events/engagements' },
    { name: 'Housewarming', href: '/events/housewarming' },
    { name: 'pooje', href: '/events/pooje' },
    { name: 'naming ceremony', href: '/events/naming-ceremony' }
  ];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Creating unforgettable moments and magical experiences for your special occasions.
            </p>
          ...
          <div>
            <h4 className="text-xl font-semibold mb-4">Our Events</h4>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">
                <span className="font-medium">Email:</span> hello@v3events.com
              </li>
              <li className="text-gray-400">
                <span className="font-medium">Address:</span> 123 Event Street, City, State 12345
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400">
            © {currentYear} V3 Events. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
